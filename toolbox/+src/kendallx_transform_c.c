/*=================================================================
 *
 * kendallx_transform_c.C	
 *
 * summary: calculate the probability integral transformation 
 *    of a sample using exchangeability
 *
 * The calling syntax is:
 *
 *		y = kendallx_transform_c(x)
 *
